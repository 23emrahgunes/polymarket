...
WHALE_COPY_MIN_SCORE_DELTA = 0.12
WHALE_COPY_MIN_SCORE_FLOOR = 0.46
WHALE_COPY_MAX_SPREAD_MULTIPLIER = 1.70
WHALE_COPY_SPREAD_PENALTY_MULTIPLIER = 1.50
WHALE_COPY_MIN_VOLUME_MULTIPLIER = 0.65
