...
WHALE_COPY_MIN_SCORE_DELTA = 0.16
WHALE_COPY_MIN_SCORE_FLOOR = 0.42
WHALE_COPY_MAX_SPREAD_MULTIPLIER = 1.90
WHALE_COPY_SPREAD_PENALTY_MULTIPLIER = 1.65
WHALE_COPY_MIN_VOLUME_MULTIPLIER = 0.55
