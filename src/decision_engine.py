...
WHALE_COPY_MIN_SCORE_DELTA = 0.20
WHALE_COPY_MIN_SCORE_FLOOR = 0.38
WHALE_COPY_MAX_SPREAD_MULTIPLIER = 2.20
WHALE_COPY_SPREAD_PENALTY_MULTIPLIER = 1.85
WHALE_COPY_MIN_VOLUME_MULTIPLIER = 0.45
